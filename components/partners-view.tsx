    ...
    <div>
      <section className="pattern-olive">
        <div className="mx-auto max-w-6xl px-4 py-16 lg:py-24">
          <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-accent">{p.kicker}</p>
          <h1 className="mt-4 font-display text-4xl leading-[1.05] text-ink md:text-6xl">{p.heroTitle}</h1>
          <p className="mt-4 text-sm font-semibold uppercase tracking-[0.12em] text-accent">{p.heroLine}</p>
      ...
      <section className="bg-hero py-24 text-center text-paper">
        <h2 className="mx-auto max-w-3xl font-display text-4xl text-paper md:text-6xl">{p.hookTitle}</h2>
        <p className="mx-auto mt-6 max-w-2xl text-paper">{p.hookLead}</p>
        <p className="mt-6 font-display text-xl text-paper">{p.hookClose}</p>
      </section>
      <section id="partner-form" className="pattern-olive border-t border-line">
        <div className="mx-auto max-w-3xl px-4 py-16">
          ...
          >
            <h2 className="font-display text-3xl text-ink">{p.formTitle}</h2>
