  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-surface/90 text-earth shadow-sm backdrop-blur transition",
        "hover:scale-105 hover:bg-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
      )}
    >
